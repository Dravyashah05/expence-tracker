        ...
        <section class="recent-section">
          <div class="recent-header">
            <div>
              ...
              <p class="text-muted">
                Latest
                {{ recentTransactions().length > 8 ? '8' : recentTransactions().length }} entries
              </p>
            </div>
                  ...
                  <div class="txn-row-main" (click)="toggleDetails(tx.id)" style="cursor:pointer;">
                    <div class="txn-left">
                      ...
                      <div class="txn-meta">
                        ...
                        <small class="txn-date"
                          >{{ tx.date | date: 'MMM d, y' }} ·
                          {{ tx.date | date: 'shortTime' }}</small
                        >
                      </div>
                    </div>
                    ...
                    <div class="txn-right">
                      ...
                      <button
                        class="expand-btn"
                        type="button"
                        (click)="$event.stopPropagation(); toggleDetails(tx.id)"
                      >
...
export class DashboardComponent {
  ...
  recentTransactions = computed(() =>
    [...this.transactionService.allTransactions()].sort(
